...
module.exports = function(file, num){
	...
	// 生成文章头尾内容
	var head = '<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no"><link rel="icon" type="image/x-icon" href="//div-wang.com/favicon.jpg">{% include "../static/blog-css.html" %} <title>' + title + '</title></head><body>{% include "../common/head.html" %}<article class="markdown-body">'
